...
Misaka Drive 是一款面向 Komari 的科技驾驶舱风格监控主题，以实时网络仪表、在线节点状态和资源遥测为核心，兼顾桌面端与移动端体验。
...
<p align="center">
  <img src="docs/images/theme-preview.png" alt="Misaka Drive 综合预览" width="90%">
</p>
...
<a href="https://www.star-history.com/?repos=beanmtcat%2FKomari-Theme-MisakaDrive&type=timeline&legend=bottom-right">
  <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=beanmtcat/Komari-Theme-MisakaDrive&type=timeline&theme=dark&legend=bottom-right" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=beanmtcat/Komari-Theme-MisakaDrive&type=timeline&legend=bottom-right" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=beanmtcat/Komari-Theme-MisakaDrive&type=timeline&legend=bottom-right" />
 </picture>
</a>
